...
async function GetPemasukan(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/TRPemasukan`,{
        method : "GET"
    })
...
async function PostPemasukan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPemasukan2", {
        method : "POST",
...
async function UpdatePemasukan(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPemasukan3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeletePemasukan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPemasukan4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetPengeluaran(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/TRPengeluaran`,{
        method : "GET"
    })
...
async function PostPengeluaran(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPengeluaran2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdatePengeluaran(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPengeluaran3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeletePengeluaran(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRPengeluaran4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetTransfer(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/TRTransfer`,{
        method : "GET"
    })
...
async function PostTransfer(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRTransfer2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateTransfer(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRTransfer3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteTransfer(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/TRTransfer4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetSetoranAnggota(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/SSetoranAnggota`,{
        method : "GET"
    })
...
async function PostSetoranAnggota(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SSetoranAnggota2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateSetoranAnggota(New, Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SSetoranAnggota3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteSetoranAnggota(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SSetoranAnggota4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetPenarikanSimpanan(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/SPenarikanSimpanan`,{
        method : "GET"
    })
...
async function PostPenarikanSimpanan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SPenarikanSimpanan2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdatePenarikanSimpanan(New, Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SPenarikanSimpanan3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeletePenarikanSimpanan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/SPenarikanSimpanan4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataPinjaman(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/PDataPinjaman`,{
        method : "GET"
    })
...
async function PostDataPinjaman(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/PDataPinjaman2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataPinjaman(New, Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/PDataPinjaman3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataPinjaman(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/PDataPinjaman4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetBayarAngsuran(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/PBayarAngsuran`,{
        method : "GET"
    })
...
async function UpdateBayarAngsuran(New, Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/PBayarAngsuran3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetJurnalUmum(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/LJurnalUmum`,{
        method : "GET"
    })
...
async function GetJenisSimpanan(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDJenisSimpanan`,{
        method : "GET"
    })
...
async function PostJenisSimpanan(Jenis_Simpanan, Kode_Akun, Tampil){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisSimpanan2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateJenisSimpanan(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisSimpanan3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteJenisSimpanan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisSimpanan4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetJenisAkun(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDJenisAkun`,{
        method : "GET"
    })
...
async function PostJenisAkun(Kode_Aktiva, Jenis_Transaksi, Akun, Pemasukan, Pengeluaran, Aktif, Laba_Rugi){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisAkun2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateJenisAkun(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisAkun3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteJenisAkun(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisAkun4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataKas(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDDataKas`,{
        method : "GET"
    })
...
async function PostDataKas(Nama_Kas, Aktif, Simpanan, Penarikan, Pinjaman, Angsuran, Pemasukan_Kas, Pengeluaran_Kas, Transfer_Kas){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataKas2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataKas(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataKas3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataKas(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataKas4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetLamaAngsuran(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDLamaAngsuran`,{
        method : "GET"
    })
...
async function PostLamaAngsuran(Lama_Angsuran, Aktif){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDLamaAngsuran2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateLamaAngsuran(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDLamaAngsuran3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteLamaAngsuran(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDLamaAngsuran4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataDepartemen(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDJenisDepartemen`,{
        method : "GET"
    })
...
async function PostDataDepartemen(Nama_Departemen){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisDepartemen2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataDepartemen(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisDepartemen3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataDepartemen(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDJenisDepartemen4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataPekerjaan(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDDataPekerjaan`,{
        method : "GET"
    })
...
async function PostDataPekerjaan(Nama_Pekerjaan){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPekerjaan2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataPekerjaan(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPekerjaan3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataPekerjaan(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPekerjaan4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataBarang(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDDataBarang`,{
        method : "GET"
    })
...
async function PostDataBarang(Nama_Barang, Type, Merk, Harga, Jumlah_Barang, Ket){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataBarang2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataBarang(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataBarang3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataBarang(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataBarang4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetDataAnggota(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDDataAnggota`,{
        method : "GET"
    })
...
async function PostDataAnggota(Username, Nama_Lengkap, JK, Alamat, Kota, Jabatan, Departemen, Tgl_Registrasi, Aktif_Keanggotaan){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataAnggota2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateDataAnggota(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataAnggota3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteDataAnggota(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataAnggota4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function ImportDataAnggota(Arr){
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataAnggota5", {
        method : "POST",
...
async function check_login2(event){
    const Parent = event.target.parentElement
    const U = Parent.querySelector('.Username input').value
    const P = Parent.querySelector('.Password input').value
    let data = {
        Username : U,
        Password : P,
    }

    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPenggunaLogin", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetLogin(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/MDDataPengguna`,{
        method : "GET"
    })
...
async function PostLogin(Username,Password,Level,Aktif){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPengguna2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateLogin(New,Old){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPengguna3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function DeleteLogin(Arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/MDDataPengguna4", {
        method : "DELETE",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetIdentitasKoperasi(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/STIdentitasKoperasi`,{
        method : "GET"
    })
...
async function PostIdentitasKoperasi(arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/STIdentitasKoperasi2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateIdentitasKoperasi(New){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/STIdentitasKoperasi3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function GetBagiHasil(){
    let response = await fetch(`https://kbmskalteng.my.id:5550/STBagiHasil`,{
        method : "GET"
    })
...
async function PostBagiHasil(arr){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/STBagiHasil2", {
        method : "POST",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
...
async function UpdateBagiHasil(New){
    ...
    let response = await fetch("https://kbmskalteng.my.id:5550/STBagiHasil3", {
        method : "PUT",
        body : JSON.stringify(data),
        headers : {'Content-type': 'application/json; charset=UTF-8',}
    })
